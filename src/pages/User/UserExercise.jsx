...
import { faEnvelopeOpen, faEye, faPhone, faUser, faUsers } from '@fortawesome/free-solid-svg-icons';
import { faInstagram, faTwitter, faFacebook } from '@fortawesome/free-brands-svg-icons';
import { Button, Modal, ModalHeader, ModalBody, ModalFooter } from 'reactstrap';

export function OtherUserExerciseLog(args) {
    ...
    return (
        <div className="row gutters mx-5 my-5">
            ...
            <div className="col-xl-9 col-lg-9 col-md-12 col-sm-12 col-12">
                ...
                <div className="card">
                    <div className="card-header d-flex justify-content-between">
                        <span>{user.fullname}'s Exercise Log</span>
                        <Link to={"/"}><FontAwesomeIcon icon={faUsers} /> View Other Users</Link>
                    </div>
                    <div className="card-body">
                                        ...
                                        <tr key={exercise._id}>
                                            ...
                                            <td className="text-center">
                                                <button type="button" className="btn btn-success btn-sm" onClick={() => { viewExerciseDetails(exercise._id) }}>
                                                    <FontAwesomeIcon icon={faEye} /> View Exercise Log Details
                                                </button>
                                            </td>
                                        </tr>
                                    )) : (
                                        <tr>
                                            <td colSpan={'6'} className="text-center">No exercise found!</td>
                                        </tr>
                                    )}
                            </tbody>
                        </table>
...
export default OtherUserExerciseLog;