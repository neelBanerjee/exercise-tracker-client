...
import { faEnvelopeOpen, faPhone, faUser, faPlusCircle, faSave } from '@fortawesome/free-solid-svg-icons';
...
export function CreateExerciseLog() {
    ...
    const formExerciseLog = document.getElementById("createExerciseForm");
    ...
    const createExerciseHandler = async (e) => {
        e.preventDefault();
        ...
        try {
            ...
            const { data: res } = await http.post('api/userexerciselog/add', formData, { headers });
            //console.log(res);
            setTimeout(() => {
                Swal.fire({ title: 'Success', text: res.message, icon: 'success' }).then(res => {
                ...
                <div className="sticky-sidebar">
                    <div className="card">
                        <div className="card-body">
                            ...
                            <form id="createExerciseForm" onSubmit={createExerciseHandler}>
                                <input type="hidden" name="userid" value={user.id || ''} />
                                <div className="row gutters">
                                    <div className="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                        <h6 className="mb-2 text-primary">Add Exercise Log Details</h6>
                                    </div>
                                    <div className="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                        <div className="form-group">
                                            <label htmlFor="fullName">Select Exercise</label>
                                            <select name="exerciseid" defaultValue={0} className="form-control" onChange={handleChange}>
                                ...
                                <div className="row gutters">
                                    <div className="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 mt-3">
                                        <div className="d-flex justify-content-between">
                                            ...
                                            {/* <button type="submit" id="submit" name="submit" className="btn btn-success" disabled={btnDisabled}>Create</button> */}
                                            <Button color="success" disabled={btnDisabled}>
                                                {btnDisabled ? (<><Spinner size="sm"></Spinner><span>{' '}Saving</span></>) : ('Create')}
                                            </Button>
                                        </div>
                                    </div>
                                </div>
